...
export function generateMeta({
  ...
  return {
    ...
    "og:url": `https://kylewigs.com${path}`,
    "og:type": type,
    "og:locale": "en_US",
    "og:site_name": "Kyle Wigley",
    ...(image
      ? {
          "og:image": image.url,
    ...
    "twitter:card": video
      ...
      ? "summary_large_image"
      : "summary",
    "twitter:site": "@kylewigs",
    "twitter:creator": "@kylewigs",
    ...
    ...(image
      ...
      : {
          "twitter:image": "https://kylewigs.com/logo.png",
        }),
    ...(video
      ? {
    ...
    author: article?.authors.map((author) => author.name) || "Kyle Wigley",
  };
}
